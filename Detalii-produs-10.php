...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-1.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-1.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-1.2.jpg" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-1.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Căști DJ V-Moda M-200-BK</h1>
            <h4>&euro;333,64</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Căști profesionale V-Moda M-200-BK, reproduce cu fidelitate frecvențe de până la 40 kHz pentru a crea un sunet atât de detaliat și precis încât este certificat Hi-Res Audio certificat de Japan Audio Society (JAS).</p>
        </div>
    </div>
