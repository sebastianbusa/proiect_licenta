...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-3.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-3.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-3.2.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-3.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Chitară acustică Flame CAG 230 BS</h1>
            <h4>&euro;70.84</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Chitară acustică Flame CAG 230 BS, mărime 3/4, are un grif lat pentru un comfort mai sporit, corzi de metal și corp din lemn de tei și arțar.</p>
        </div>
    </div>
