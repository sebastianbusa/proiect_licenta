...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-5.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-5.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-5.2.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-5.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Mixer DJ Pioneer DJM-V10</h1>
            <h4>&euro;3440.35</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Mixer de club Pioneer DJM-V10-LF cu 6 canale si fadere mai lungi, EQ cu 4 benzi pe canal, compressor intern, sectiune cu 14 efecte, izolator pe 3 benzi, 2 iesiri pentru casti si EQ pentru booth, 6 intrari digitale (coaxial), 6 intrari line, 4 intrari phono.</p>
        </div>
    </div>
