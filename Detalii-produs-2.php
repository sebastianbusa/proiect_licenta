...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-4.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-4.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-4.2.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-4.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Set tobe electrice Roland TD-1KPX2</h1>
            <h4>&euro;1119.06</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Set tobe electronice Roland TD-1KPX2 compact și portabil, ce oferă același design inovator, foarte apreciat, al TD-1KPX V-Drums, cu un pad de kick actualizat. Beneficiază de Roland mesh-head V-Pads pentru snare și tomuri, și oferă o experiență inspirată de a cânta la tobe.</p>
        </div>
    </div>
