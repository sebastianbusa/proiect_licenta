...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-8.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-8.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-8.2.jpg" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-8.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Mixer Behringer DDM4000</h1>
            <h4>&euro;357.23</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Mixer Behringer DDM4000 cu 4 canale stereo + 1 canal mono, 2 intrări de microfon cu gain, EQ cu 3 benzi, funcție Talk și efecte, ideal pentru ati începe cariera de DJ.</p>
        </div>
    </div>
