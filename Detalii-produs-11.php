...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-2.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-2.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-2.2.jpg" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-2.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Mixer analogic Proel MQ16USB</h1>
            <h4>&euro;495,50</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Mixer analogic Proel MQ16USB cu 16 canale, procesor de efecte Proel și interfață audio prin USB. MQ este o serie de mixere create de PROEL pentru a oferi într-un pachet foarte compact și elegant o densitate mare de intrare, un set complet de caracteristici și o calitate audio superioară, la un preț foarte convenabil.</p>
        </div>
    </div>
