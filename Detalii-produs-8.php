...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-9.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-9.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-9.2.jpg" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-9.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Boxă activă Yamaha DBR 15</h1>
            <h4>&euro;580.88</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Boxă activă Yamaha DBR 15, cu o garanție de 4 ani, tip 2 cai bi-amplificată cu bass-reflex și cu putere de ieșire Dynamic 1000W, nivel maxim 132 dB. Dimensiuni de 455mm x 700mm x 378mm.</p>
        </div>
    </div>
