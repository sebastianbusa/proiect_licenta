...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-11.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-11.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-11.2.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-11.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Controller Pioneer DDJ-FLX6</h1>
            <h4>&euro;606,57</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Arată-ți adevărata performanță și pune stăpânire pe sunetele tale cu noua serie Controller Pioneer DDJ-FLX6. O consolă all-in-one cu 2 deck-uri, 2 canale și o interfață excepțională va intensifica experiența trăită de DJ într-un mod profesional și autentic.</p>
        </div>
    </div>
