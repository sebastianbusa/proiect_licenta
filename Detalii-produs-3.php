...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-6.png" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-6.1.png" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-6.2.png" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-6.3.png" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Microfon wireless Eikon EKJM</h1>
            <h4>&euro;139.45</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Sistem wireless Eikon EKJM fără fir pe UHF care oferă o transmisie de semnal de înaltă calitate și fiabilă. EKJM vine cu 3 unități: transmițător portabil EKJM, receptor compact EKJM „format conector” și cablu de încărcare USB la USB-C.</p>
        </div>
    </div>
