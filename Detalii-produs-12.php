...
<div class="small-container single-product">
    ...
    <div class="row">
        <div class="col-2">
            <img src="imagines/Product-12.jpg" width="100%" id="productImg">

            <div class="small-img-row">

                <div class="small-img-col">
                    <img src="imagines/Product-12.1.jpg" width="100%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-12.2.jpg" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="imagines/Product-12.3.jpg" width="100%" class="small-img">
                </div>
            </div>
        ...
        <div class="col-2">
            ...
            <h1>Microfon studio SE Electronics SE 2200</h1>
            <h4>&euro;234,50</h4>
            <h3>Detaliile produsului <i class="fa fa-indent"></i></h3>
            <p>Microfon studio SE Electronics SE 2200 condensator cu diafragma mare, cardioid cu membrana dublă Gold-plated 1 și o plajă de frecvență între 20 și 20.000 Hz. Necesită +48 V phantom power.</p>
        </div>
    </div>
